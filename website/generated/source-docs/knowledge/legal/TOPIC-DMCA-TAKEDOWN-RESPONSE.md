---
id: TOPIC-DMCA-TAKEDOWN-RESPONSE
title: DMCA Takedown and Counter-Notification
type: topic
status: draft
summary: U.S. DMCA notice-and-takedown and counter-notification procedure under 17 U.S.C. § 512, documented from statute and cited sources.
tags:
  - copyright
  - safe-harbor
  - digital-rights
...
relationships:
  - subject: TOPIC-DMCA-TAKEDOWN-RESPONSE
    predicate: cites
    object: SRC-USC-17-512-LII
    sources:
      - SRC-USC-17-512-LII
  - subject: TOPIC-DMCA-TAKEDOWN-RESPONSE
    predicate: cites
  ...
  - subject: TOPIC-DMCA-TAKEDOWN-RESPONSE
    predicate: cites
    object: SRC-LENZ-V-UNIVERSAL-CA9
    sources:
      - SRC-LENZ-V-UNIVERSAL-CA9
  - subject: TOPIC-DMCA-TAKEDOWN-RESPONSE
    predicate: related_to
    object: STAT-DMCA-512
    sources:
      - SRC-USC-17-512-LII
  - subject: TOPIC-DMCA-TAKEDOWN-RESPONSE
    predicate: related_to
    object: TOPIC-FAIR-USE-VIDEO
    sources:
      - SRC-EFF-BLOGGERS-IP
  - subject: TOPIC-DMCA-TAKEDOWN-RESPONSE
    predicate: related_to
...
- Source path: `knowledge/legal/TOPIC-DMCA-TAKEDOWN-RESPONSE.md`
- Source ID: `TOPIC-DMCA-TAKEDOWN-RESPONSE`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/TOPIC-DMCA-TAKEDOWN-RESPONSE.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+TOPIC-DMCA-TAKEDOWN-RESPONSE)
...
This page documents U.S. Digital Millennium Copyright Act notice-and-takedown and counter-notification procedure under 17 U.S.C. § 512. For fair use analysis of the underlying material, see [Fair Use and Video](TOPIC-FAIR-USE-VIDEO.md).
...
- In [Lenz v. Universal Music Corp.](CASE-LENZ-V-UNIVERSAL.md), the Ninth Circuit held that the DMCA requires copyright holders to consider fair use before sending a takedown notification.[^3]
...
[^2]: [`SRC-EFF-BLOGGERS-IP`](../../../bibliography.md#SRC-EFF-BLOGGERS-IP) — EFF Legal Guide for Bloggers — Intellectual Property. Official educational guide summarizing § 512 requirements; secondary source.

[^3]: [`SRC-LENZ-V-UNIVERSAL-CA9`](../../../bibliography.md#SRC-LENZ-V-UNIVERSAL-CA9) — Lenz v. Universal Music Corp., 801 F.3d 1126 (9th Cir. 2015). Primary authority.

[^4]: [`SRC-COPYRIGHT-512-INDEX`](../../../bibliography.md#SRC-COPYRIGHT-512-INDEX) — U.S. Copyright Office Section 512 Resources. Official government index.
...
Statutory text of § 512(c)(3) and § 512(g) has not yet been quoted directly from GovInfo on this page. See [`STAT-DMCA-512`](STAT-DMCA-512.md).

## Relationships

- `TOPIC-DMCA-TAKEDOWN-RESPONSE` cites [`SRC-USC-17-512-LII`](https://www.law.cornell.edu/uscode/text/17/512).
- `TOPIC-DMCA-TAKEDOWN-RESPONSE` cites [`SRC-EFF-BLOGGERS-IP`](../../../bibliography.md#SRC-EFF-BLOGGERS-IP).
- `TOPIC-DMCA-TAKEDOWN-RESPONSE` cites [`SRC-LENZ-V-UNIVERSAL-CA9`](../../../bibliography.md#SRC-LENZ-V-UNIVERSAL-CA9).
...
1. [`SRC-USC-17-512-LII`](https://www.law.cornell.edu/uscode/text/17/512): 17 U.S.C. § 512.
2. [`SRC-EFF-BLOGGERS-IP`](../../../bibliography.md#SRC-EFF-BLOGGERS-IP): EFF Legal Guide for Bloggers — Intellectual Property.
3. [`SRC-LENZ-V-UNIVERSAL-CA9`](../../../bibliography.md#SRC-LENZ-V-UNIVERSAL-CA9): Lenz v. Universal Music Corp., 801 F.3d 1126 (9th Cir. 2015).
4. [`SRC-COPYRIGHT-512-INDEX`](../../../bibliography.md#SRC-COPYRIGHT-512-INDEX): U.S. Copyright Office Section 512 Resources.

Additional sources (not yet cited in footnotes):

- [`SRC-USC-17-512-GOVINFO`](https://www.govinfo.gov/link/uscode/17/512): 17 U.S.C. § 512 (GovInfo).
