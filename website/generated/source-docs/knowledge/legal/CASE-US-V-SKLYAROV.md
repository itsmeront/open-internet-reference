---
id: CASE-US-V-SKLYAROV
title: United States v. Sklyarov / Elcomsoft
type: case
status: draft
summary: Dmitry Sklyarov and Elcomsoft Co. Ltd. were indicted in 2001 under the DMCA for trafficking in ebook circumvention software; Sklyarov entered a deferred-prosecution agreement, and DOJ described the matter as the first DMCA criminal case.
tags:
  - case
  - copyright
  - open-source-risk
...
relationships:
  - subject: CASE-US-V-SKLYAROV
    predicate: cites
    object: SRC-DOJ-SKLYAROV-AGREE-2001
    sources:
      - SRC-DOJ-SKLYAROV-AGREE-2001
  - subject: CASE-US-V-SKLYAROV
...
- Source path: `knowledge/legal/CASE-US-V-SKLYAROV.md`
- Source ID: `CASE-US-V-SKLYAROV`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/CASE-US-V-SKLYAROV.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+CASE-US-V-SKLYAROV)
...
[^1]: [`SRC-DOJ-SKLYAROV-INDICTMENT-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-INDICTMENT-2001) — DOJ First DMCA Indictment Against Sklyarov and Elcomsoft (Aug. 28, 2001). Archived official press release.
[^2]: [`SRC-DOJ-SKLYAROV-AGREE-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-AGREE-2001) — DOJ Sklyarov Enters Agreement (Dec. 13, 2001). Official archived press release.
[^3]: [`SRC-EFF-SKLYAROV-CASE`](../../../bibliography.md#SRC-EFF-SKLYAROV-CASE) — EFF Case Page — US v. ElcomSoft / Sklyarov. Organization case page; corroboration pending for company verdict.
...
- `CASE-US-V-SKLYAROV` cites [`SRC-DOJ-SKLYAROV-AGREE-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-AGREE-2001).
- `CASE-US-V-SKLYAROV` related_to `TOPIC-DEVELOPER-SOFTWARE-LIABILITY`.
- `CASE-US-V-SKLYAROV` related_to `CASE-UNIVERSAL-V-CORLEY`.

## Sources

1. [`SRC-DOJ-SKLYAROV-INDICTMENT-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-INDICTMENT-2001): DOJ — First DMCA Indictment Against Sklyarov and Elcomsoft (Aug. 28, 2001).
2. [`SRC-DOJ-SKLYAROV-AGREE-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-AGREE-2001): DOJ — Sklyarov Enters Agreement in First DMCA Criminal Case (Dec. 13, 2001).
3. [`SRC-EFF-SKLYAROV-CASE`](../../../bibliography.md#SRC-EFF-SKLYAROV-CASE): EFF Case Page — US v. ElcomSoft / Sklyarov.
