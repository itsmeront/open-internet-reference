...
- Source path: `knowledge/legal/CASE-NYT-V-OPENAI.md`
- Source ID: `CASE-NYT-V-OPENAI`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/CASE-NYT-V-OPENAI.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+CASE-NYT-V-OPENAI)
...
[^1]: [`SRC-NYT-V-OPENAI-COMPLAINT`](../../../bibliography.md#SRC-NYT-V-OPENAI-COMPLAINT) — Original Times complaint (Dec. 27, 2023). Plaintiff allegations.

[^2]: [`SRC-NYT-V-OPENAI-MTD-2025`](../../../bibliography.md#SRC-NYT-V-OPENAI-MTD-2025) — Opinion (Apr. 4, 2025). Primary district-court pleading-stage authority.

[^3]: [`SRC-NYT-V-OPENAI-12C-2026`](../../../bibliography.md#SRC-NYT-V-OPENAI-12C-2026) — Order (Aug. 6, 2026). Primary district-court authority on later contributory-claim dismissal.

[^4]: [`SRC-JPML-OPENAI-MDL-3143`](../../../bibliography.md#SRC-JPML-OPENAI-MDL-3143) — JPML Transfer Order, MDL No. 3143. Primary for centralization of the Times action.

[^5]: [`SRC-NYT-V-PERPLEXITY-DOCKET`](../../../bibliography.md#SRC-NYT-V-PERPLEXITY-DOCKET) — CourtListener docket for No. 1:25-cv-10106. Primary for the later Times filing against Perplexity.
...
- `CASE-NYT-V-OPENAI` cites [`SRC-NYT-V-OPENAI-MTD-2025`](../../../bibliography.md#SRC-NYT-V-OPENAI-MTD-2025).
...
1. [`SRC-NYT-V-OPENAI-COMPLAINT`](../../../bibliography.md#SRC-NYT-V-OPENAI-COMPLAINT): Times complaint (Dec. 27, 2023).
2. [`SRC-NYT-V-OPENAI-MTD-2025`](../../../bibliography.md#SRC-NYT-V-OPENAI-MTD-2025): Opinion on motions to dismiss (Apr. 4, 2025).
3. [`SRC-NYT-V-OPENAI-12C-2026`](../../../bibliography.md#SRC-NYT-V-OPENAI-12C-2026): Order on Rule 12(c) contributory claims (Aug. 6, 2026).
4. [`SRC-JPML-OPENAI-MDL-3143`](../../../bibliography.md#SRC-JPML-OPENAI-MDL-3143): JPML Transfer Order, MDL No. 3143.
5. [`SRC-NYT-V-PERPLEXITY-DOCKET`](../../../bibliography.md#SRC-NYT-V-PERPLEXITY-DOCKET): CourtListener docket for Times v. Perplexity, No. 1:25-cv-10106.
