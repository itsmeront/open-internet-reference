...
- Source path: `knowledge/legal/TOPIC-APP-STORE-AGE-VERIFICATION.md`
- Source ID: `TOPIC-APP-STORE-AGE-VERIFICATION`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/TOPIC-APP-STORE-AGE-VERIFICATION.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+TOPIC-APP-STORE-AGE-VERIFICATION)
...
[^1]: [`SRC-CA-CIV-1798-500-DIGITAL-AGE-ASSURANCE`](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.9.&part=4.&chapter=&article=) — California Civil Code Title 1.81.9 (leginfo). Primary statute.
[^2]: [`SRC-CA-AB-1043-STATUS`](https://leginfo.legislature.ca.gov/faces/billStatusClient.xhtml?bill_id=202520260AB1043) — AB 1043 chaptered Oct. 13, 2025. Official status.
[^3]: [`SRC-TX-SB-2420-ENROLLED`](https://capitol.texas.gov/tlodocs/89R/billtext/html/SB02420F.HTM) — Texas SB 2420 enrolled. Primary statute.
[^4]: [`SRC-CCIA-V-PAXTON-PI-ORDER`](https://storage.courtlistener.com/recap/gov.uscourts.txwd.1172869998/gov.uscourts.txwd.1172869998.65.0.pdf) — W.D. Tex. PI order (Dec. 23, 2025).
[^5]: [`SRC-CA5-SB2420-STAY-ORDER`](https://www.ca5.uscourts.gov/opinions/pub/26/26-50001-CV0.pdf) — Fifth Circuit stay (June 4, 2026).
[^6]: [`SRC-CCIA-SB2420-LITIGATION-PAGE`](https://ccianet.org/litigation/ccia-v-paxton-w-d-tex/) — CCIA litigation timeline (party secondary).
[^7]: [`SRC-TX-TRIBUNE-SB2420-SCOTUS-2026`](https://www.texastribune.org/2026/05/28/texas-apple-google-app-store-age-verification/) — Texas Tribune on SCOTUS non-intervention (journalism; date tension with CCIA).
[^8]: [`SRC-LA-ACT-185-ASAA`](https://legis.la.gov/legis/ViewDocument.aspx?d=1475238) — Louisiana Act No. 185 enrolled text.
[^9]: [`SRC-AL-HB161-ENROLLED`](https://alison.legislature.state.al.us/files/pdf/SearchableInstruments/2026RS/HB161-enr.pdf) — Alabama HB 161 enrolled PDF.
[^10]: [`SRC-ALSTON-UTAH-ASAA-DISMISSAL-2026`](https://www.alstonprivacy.com/challenge-to-utahs-app-store-accountability-act-voluntarily-dismissed-following-statutory-amendments/) — Alston & Bird alert on Utah amendments and dismissal (secondary).
...
1. [`SRC-CA-CIV-1798-500-DIGITAL-AGE-ASSURANCE`](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.9.&part=4.&chapter=&article=): California Civil Code Title 1.81.9.
2. [`SRC-CA-AB-1043-STATUS`](https://leginfo.legislature.ca.gov/faces/billStatusClient.xhtml?bill_id=202520260AB1043): California AB 1043 Bill Status.
3. [`SRC-TX-SB-2420-ENROLLED`](https://capitol.texas.gov/tlodocs/89R/billtext/html/SB02420F.HTM): Texas SB 2420 Enrolled Text.
4. [`SRC-CCIA-V-PAXTON-PI-ORDER`](https://storage.courtlistener.com/recap/gov.uscourts.txwd.1172869998/gov.uscourts.txwd.1172869998.65.0.pdf): CCIA v. Paxton PI Order.
5. [`SRC-CA5-SB2420-STAY-ORDER`](https://www.ca5.uscourts.gov/opinions/pub/26/26-50001-CV0.pdf): Fifth Circuit Stay Order.
6. [`SRC-CCIA-SB2420-LITIGATION-PAGE`](https://ccianet.org/litigation/ccia-v-paxton-w-d-tex/): CCIA Litigation Page.
7. [`SRC-TX-TRIBUNE-SB2420-SCOTUS-2026`](https://www.texastribune.org/2026/05/28/texas-apple-google-app-store-age-verification/): Texas Tribune SCOTUS coverage.
8. [`SRC-LA-ACT-185-ASAA`](https://legis.la.gov/legis/ViewDocument.aspx?d=1475238): Louisiana Act No. 185.
9. [`SRC-AL-HB161-ENROLLED`](https://alison.legislature.state.al.us/files/pdf/SearchableInstruments/2026RS/HB161-enr.pdf): Alabama HB 161 Enrolled.
10. [`SRC-ALSTON-UTAH-ASAA-DISMISSAL-2026`](https://www.alstonprivacy.com/challenge-to-utahs-app-store-accountability-act-voluntarily-dismissed-following-statutory-amendments/): Alston & Bird Utah ASAA dismissal alert.
