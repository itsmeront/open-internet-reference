---
id: CASE-CHATRIE-V-US
title: Chatrie v. United States
type: case
status: draft
summary: Chatrie v. United States, No. 25-112 (June 29, 2026), held that police conduct a Fourth Amendment search when they acquire an individual’s Google Location History data through a geofence warrant process, vacated the Fourth Circuit, and remanded warrant particularity/probable-cause questions.
tags:
  - fourth-amendment
  - privacy
  - digital-rights
...
sources:
  - SRC-CHATRIE-LII
  - SRC-CHATRIE-SCOTUS-PDF
  - SRC-HILL-MARLOW-REVERSE-WARRANTS-2026
  - SRC-CARPENTER-LII
relationships:
  - subject: CASE-CHATRIE-V-US
    predicate: cites
    object: SRC-CHATRIE-LII
    sources:
      - SRC-CHATRIE-LII
  - subject: CASE-CHATRIE-V-US
    predicate: cites
    object: SRC-CHATRIE-SCOTUS-PDF
    sources:
      - SRC-CHATRIE-SCOTUS-PDF
  - subject: CASE-CHATRIE-V-US
...
- Source path: `knowledge/legal/CASE-CHATRIE-V-US.md`
- Source ID: `CASE-CHATRIE-V-US`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/CASE-CHATRIE-V-US.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+CASE-CHATRIE-V-US)
...
- The Court relied on and extended the privacy framework of [Carpenter v. United States](CASE-CARPENTER-V-US.md), including that people have a reasonable expectation of privacy in the whole of their physical movements.[^1][^2]
...
[^1]: [`SRC-CHATRIE-LII`](https://www.law.cornell.edu/supremecourt/text/25-112) — Chatrie v. United States, No. 25-112 (June 29, 2026) (Cornell LII). Primary authority (syllabus/opinion).
...
[^3]: [`SRC-HILL-MARLOW-REVERSE-WARRANTS-2026`](https://thehill.com/opinion/criminal-justice/5998614-supreme-court-privacy-ruling/) — The Hill — Chad Marlow Opinion on Reverse Warrants / Chatrie (July 30, 2026). Opinion/advocacy commentary.
...
- `CASE-CHATRIE-V-US` cites [`SRC-CHATRIE-LII`](https://www.law.cornell.edu/supremecourt/text/25-112).
- `CASE-CHATRIE-V-US` cites [`SRC-CHATRIE-SCOTUS-PDF`](https://www.supremecourt.gov/opinions/25pdf/25-112_0am4.pdf).
- `CASE-CHATRIE-V-US` related_to `TOPIC-FOURTH-AMENDMENT`.
- `CASE-CHATRIE-V-US` related_to `CASE-CARPENTER-V-US`.

## Sources

1. [`SRC-CHATRIE-LII`](https://www.law.cornell.edu/supremecourt/text/25-112): Chatrie v. United States, No. 25-112 (June 29, 2026) (Cornell LII).
...
3. [`SRC-HILL-MARLOW-REVERSE-WARRANTS-2026`](https://thehill.com/opinion/criminal-justice/5998614-supreme-court-privacy-ruling/): The Hill — Chad Marlow Opinion on Reverse Warrants / Chatrie (July 30, 2026).

Additional sources (not yet cited in footnotes):

- [`SRC-CHATRIE-SCOTUS-PDF`](https://www.supremecourt.gov/opinions/25pdf/25-112_0am4.pdf): Chatrie v. United States slip opinion PDF (supremecourt.gov).
