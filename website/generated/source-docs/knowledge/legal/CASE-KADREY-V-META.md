...
- Source path: `knowledge/legal/CASE-KADREY-V-META.md`
- Source ID: `CASE-KADREY-V-META`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/CASE-KADREY-V-META.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+CASE-KADREY-V-META)
...
[^1]: [`SRC-KADREY-V-META-FAIR-USE`](../../../bibliography.md#SRC-KADREY-V-META-FAIR-USE) — Order on partial summary judgment (June 25, 2025). Primary district-court authority.
...
- `CASE-KADREY-V-META` cites [`SRC-KADREY-V-META-FAIR-USE`](../../../bibliography.md#SRC-KADREY-V-META-FAIR-USE).
...
1. [`SRC-KADREY-V-META-FAIR-USE`](../../../bibliography.md#SRC-KADREY-V-META-FAIR-USE): Kadrey v. Meta Platforms, Inc., 788 F. Supp. 3d 1026 (N.D. Cal. 2025).
