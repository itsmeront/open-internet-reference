---
id: CASE-GARCIA-V-CHARACTER-TECHNOLOGIES
title: Garcia v. Character Technologies, Inc.
type: case
status: draft
summary: Garcia v. Character Technologies, Inc., No. 6:24-cv-01903 (M.D. Fla.), is a pending wrongful-death and product-liability action over a Character.AI chatbot; the court allowed most claims to proceed in May 2025 and declined to treat chatbot output as protected speech at the pleading stage.
tags:
  - case
  - first-amendment
...
sources:
  - SRC-GARCIA-V-CHARACTER-COMPLAINT
  - SRC-GARCIA-V-CHARACTER-MTD-2025
relationships:
  - subject: CASE-GARCIA-V-CHARACTER-TECHNOLOGIES
    predicate: cites
    object: SRC-GARCIA-V-CHARACTER-MTD-2025
    sources:
      - SRC-GARCIA-V-CHARACTER-MTD-2025
  - subject: CASE-GARCIA-V-CHARACTER-TECHNOLOGIES
...
- Source path: `knowledge/legal/CASE-GARCIA-V-CHARACTER-TECHNOLOGIES.md`
- Source ID: `CASE-GARCIA-V-CHARACTER-TECHNOLOGIES`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/CASE-GARCIA-V-CHARACTER-TECHNOLOGIES.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+CASE-GARCIA-V-CHARACTER-TECHNOLOGIES)
...
- The court discussed [Brown v. Entertainment Merchants Assn.](CASE-BROWN-V-ENTERTAINMENT-MERCHANTS.md) and Moody v. NetChoice, LLC as defendants’ analogies, but held the operative question is whether Character.AI’s output is expressive speech, not merely whether chatbots resemble games or social-media feeds.[^2]
...
[^1]: [`SRC-GARCIA-V-CHARACTER-COMPLAINT`](../../../bibliography.md#SRC-GARCIA-V-CHARACTER-COMPLAINT) — Original complaint (Oct. 22, 2024). Plaintiff allegations; this page does not reproduce alleged chatbot content or details of the death.

[^2]: [`SRC-GARCIA-V-CHARACTER-MTD-2025`](../../../bibliography.md#SRC-GARCIA-V-CHARACTER-MTD-2025) — Order on motions to dismiss (May 20, 2025). Primary district-court pleading-stage authority.
...
- `CASE-GARCIA-V-CHARACTER-TECHNOLOGIES` cites [`SRC-GARCIA-V-CHARACTER-MTD-2025`](../../../bibliography.md#SRC-GARCIA-V-CHARACTER-MTD-2025).
- `CASE-GARCIA-V-CHARACTER-TECHNOLOGIES` related_to `TOPIC-AI-LITIGATION`.
- `CASE-GARCIA-V-CHARACTER-TECHNOLOGIES` related_to `TOPIC-AI-HARM-LITIGATION`.
...
1. [`SRC-GARCIA-V-CHARACTER-COMPLAINT`](../../../bibliography.md#SRC-GARCIA-V-CHARACTER-COMPLAINT): Original complaint (Oct. 22, 2024).
2. [`SRC-GARCIA-V-CHARACTER-MTD-2025`](../../../bibliography.md#SRC-GARCIA-V-CHARACTER-MTD-2025): Order on motions to dismiss (May 20, 2025).
