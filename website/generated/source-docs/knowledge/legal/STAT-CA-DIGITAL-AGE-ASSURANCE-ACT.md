...
- Source path: `knowledge/legal/STAT-CA-DIGITAL-AGE-ASSURANCE-ACT.md`
- Source ID: `STAT-CA-DIGITAL-AGE-ASSURANCE-ACT`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/STAT-CA-DIGITAL-AGE-ASSURANCE-ACT.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+STAT-CA-DIGITAL-AGE-ASSURANCE-ACT)
...
[^1]: [`SRC-CA-CIV-1798-500-DIGITAL-AGE-ASSURANCE`](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.9.&part=4.&chapter=&article=) — California Civil Code Title 1.81.9 (leginfo). Primary statute text.
[^2]: [`SRC-CA-AB-1043-STATUS`](https://leginfo.legislature.ca.gov/faces/billStatusClient.xhtml?bill_id=202520260AB1043) — California AB 1043 bill status (chaptered Oct. 13, 2025). Official legislative status.

## Relationships

- `STAT-CA-DIGITAL-AGE-ASSURANCE-ACT` cites [`SRC-CA-CIV-1798-500-DIGITAL-AGE-ASSURANCE`](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.9.&part=4.&chapter=&article=).
- `STAT-CA-DIGITAL-AGE-ASSURANCE-ACT` cites [`SRC-CA-AB-1043-STATUS`](https://leginfo.legislature.ca.gov/faces/billStatusClient.xhtml?bill_id=202520260AB1043).
- `STAT-CA-DIGITAL-AGE-ASSURANCE-ACT` related_to `TOPIC-APP-STORE-AGE-VERIFICATION`.

## Sources

1. [`SRC-CA-CIV-1798-500-DIGITAL-AGE-ASSURANCE`](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=CIV&division=3.&title=1.81.9.&part=4.&chapter=&article=): California Civil Code Title 1.81.9 — Digital Age Assurance Act (leginfo).
2. [`SRC-CA-AB-1043-STATUS`](https://leginfo.legislature.ca.gov/faces/billStatusClient.xhtml?bill_id=202520260AB1043): California AB 1043 Bill Status — Chaptered October 13, 2025.
