...
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/TOPIC-CODE-AS-SPEECH.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+TOPIC-CODE-AS-SPEECH)
...
[^3]: [`SRC-BERNSTEIN-JUSTIA`](../../../bibliography.md#SRC-BERNSTEIN-JUSTIA) — Bernstein v. United States Department of Justice, 176 F.3d 1132 (9th Cir. 1999) (Justia). Primary authority.
[^4]: [`SRC-JUNGER-CMU`](../../../bibliography.md#SRC-JUNGER-CMU) — Junger v. Daley Opinion Text (CMU). Primary authority.
[^5]: [`SRC-CORLEY-LII`](../../../bibliography.md#SRC-CORLEY-LII) — Universal City Studios v. Corley Opinion Text (Open Casebook). Primary authority.
...
- `TOPIC-CODE-AS-SPEECH` cites [`SRC-US-CONST-AMEND-I-LII`](https://www.law.cornell.edu/constitution/first_amendment).
- `TOPIC-CODE-AS-SPEECH` cites [`SRC-RENO-V-ACLU-LOC`](https://tile.loc.gov/storage-services/service/ll/usrep/usrep521/usrep521844/usrep521844.pdf).
- `TOPIC-CODE-AS-SPEECH` cites [`SRC-BERNSTEIN-JUSTIA`](../../../bibliography.md#SRC-BERNSTEIN-JUSTIA).
- `TOPIC-CODE-AS-SPEECH` cites [`SRC-JUNGER-CMU`](../../../bibliography.md#SRC-JUNGER-CMU).
- `TOPIC-CODE-AS-SPEECH` cites [`SRC-CORLEY-LII`](../../../bibliography.md#SRC-CORLEY-LII).
...
2. [`SRC-RENO-V-ACLU-GOVINFO`](https://www.govinfo.gov/app/details/USREPORTS-521/USREPORTS-521-844): Reno v. American Civil Liberties Union, 521 U.S. 844 (1997) (GovInfo).
3. [`SRC-BERNSTEIN-JUSTIA`](../../../bibliography.md#SRC-BERNSTEIN-JUSTIA): Bernstein v. United States Department of Justice, 176 F.3d 1132 (9th Cir. 1999) (Justia).
4. [`SRC-JUNGER-CMU`](../../../bibliography.md#SRC-JUNGER-CMU): Junger v. Daley Opinion Text (CMU).
5. [`SRC-CORLEY-LII`](../../../bibliography.md#SRC-CORLEY-LII): Universal City Studios v. Corley Opinion Text (Open Casebook).
