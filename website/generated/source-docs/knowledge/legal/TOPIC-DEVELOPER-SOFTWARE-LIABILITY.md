...
- Source path: `knowledge/legal/TOPIC-DEVELOPER-SOFTWARE-LIABILITY.md`
- Source ID: `TOPIC-DEVELOPER-SOFTWARE-LIABILITY`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/TOPIC-DEVELOPER-SOFTWARE-LIABILITY.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+TOPIC-DEVELOPER-SOFTWARE-LIABILITY)
...
[^1]: [`SRC-IRS-SAMOURAI-PLEA-2025`](../../../bibliography.md#SRC-IRS-SAMOURAI-PLEA-2025) — IRS-CI Samourai Wallet Founders Plead Guilty (July 30, 2025). Official government announcement.
[^2]: [`SRC-IRS-SAMOURAI-SENTENCE-2025`](../../../bibliography.md#SRC-IRS-SAMOURAI-SENTENCE-2025) — IRS-CI Samourai Wallet Founders Sentenced (Nov. 2025). Official government announcement.
[^3]: [`SRC-DOJ-STORM-INDICTMENT`](../../../bibliography.md#SRC-DOJ-STORM-INDICTMENT) — United States v. Storm / Semenov Indictment (S.D.N.Y. Aug. 2023). Charging instrument.
...
[^5]: [`SRC-PERTSEV-ECLI-2024`](../../../bibliography.md#SRC-PERTSEV-ECLI-2024) — ECLI:NL:RBOBR:2024:2069 (May 14, 2024). Primary Dutch judgment.
[^6]: [`SRC-TREASURY-BLENDER-2022`](../../../bibliography.md#SRC-TREASURY-BLENDER-2022) — Treasury Blender.io Designation (May 6, 2022). Official government press release.
[^7]: [`SRC-TREASURY-TC-AUG-2022`](../../../bibliography.md#SRC-TREASURY-TC-AUG-2022) — Treasury Tornado Cash Designation (Aug. 8, 2022). Official government press release.
[^8]: [`SRC-VAN-LOON-5TH-CIR-JUSTIA`](../../../bibliography.md#SRC-VAN-LOON-5TH-CIR-JUSTIA) — Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024). Primary authority.
[^9]: [`SRC-ZIMMERMANN-DECLINATION-1996`](../../../bibliography.md#SRC-ZIMMERMANN-DECLINATION-1996) — Zimmermann PGP Investigation Closed (Jan. 1996). Republished declination.
[^10]: [`SRC-DOJ-SKLYAROV-INDICTMENT-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-INDICTMENT-2001) — DOJ First DMCA Indictment (Aug. 28, 2001). Archived official press release.
[^11]: [`SRC-DOJ-SKLYAROV-AGREE-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-AGREE-2001) — DOJ Sklyarov Agreement (Dec. 13, 2001). Official archived press release.
[^12]: [`SRC-CORLEY-LII`](../../../bibliography.md#SRC-CORLEY-LII) — Universal City Studios v. Corley (Cornell LII / related Corley source). Primary authority cross-check on CASE page.
[^13]: [`SRC-BERNSTEIN-JUSTIA`](../../../bibliography.md#SRC-BERNSTEIN-JUSTIA) — Bernstein v. DOJ, 176 F.3d 1132 (9th Cir. 1999). Primary authority.
[^14]: [`SRC-JUNGER-CMU`](../../../bibliography.md#SRC-JUNGER-CMU) — Junger v. Daley Opinion Text (CMU). Primary authority.
...
- `TOPIC-DEVELOPER-SOFTWARE-LIABILITY` cites [`SRC-IRS-SAMOURAI-SENTENCE-2025`](../../../bibliography.md#SRC-IRS-SAMOURAI-SENTENCE-2025).
...
1. [`SRC-IRS-SAMOURAI-PLEA-2025`](../../../bibliography.md#SRC-IRS-SAMOURAI-PLEA-2025): IRS-CI — Samourai Wallet Founders Plead Guilty (July 30, 2025).
2. [`SRC-IRS-SAMOURAI-SENTENCE-2025`](../../../bibliography.md#SRC-IRS-SAMOURAI-SENTENCE-2025): IRS-CI — Samourai Wallet Founders Sentenced (Nov. 2025).
3. [`SRC-DOJ-STORM-INDICTMENT`](../../../bibliography.md#SRC-DOJ-STORM-INDICTMENT): United States v. Storm / Semenov Indictment (S.D.N.Y. Aug. 2023).
...
5. [`SRC-PERTSEV-ECLI-2024`](../../../bibliography.md#SRC-PERTSEV-ECLI-2024): ECLI:NL:RBOBR:2024:2069 (May 14, 2024).
6. [`SRC-TREASURY-BLENDER-2022`](../../../bibliography.md#SRC-TREASURY-BLENDER-2022): Treasury Blender.io Designation (May 6, 2022).
7. [`SRC-TREASURY-TC-AUG-2022`](../../../bibliography.md#SRC-TREASURY-TC-AUG-2022): Treasury Tornado Cash Designation (Aug. 8, 2022).
8. [`SRC-VAN-LOON-5TH-CIR-JUSTIA`](../../../bibliography.md#SRC-VAN-LOON-5TH-CIR-JUSTIA): Van Loon v. Department of the Treasury (5th Cir. Nov. 26, 2024).
9. [`SRC-ZIMMERMANN-DECLINATION-1996`](../../../bibliography.md#SRC-ZIMMERMANN-DECLINATION-1996): Zimmermann PGP Investigation Closed (Jan. 1996).
10. [`SRC-DOJ-SKLYAROV-INDICTMENT-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-INDICTMENT-2001): DOJ First DMCA Indictment (Aug. 28, 2001).
11. [`SRC-DOJ-SKLYAROV-AGREE-2001`](../../../bibliography.md#SRC-DOJ-SKLYAROV-AGREE-2001): DOJ Sklyarov Agreement (Dec. 13, 2001).
12. [`SRC-CORLEY-LII`](../../../bibliography.md#SRC-CORLEY-LII): Universal City Studios v. Corley source record.
13. [`SRC-BERNSTEIN-JUSTIA`](../../../bibliography.md#SRC-BERNSTEIN-JUSTIA): Bernstein v. DOJ (Justia).
14. [`SRC-JUNGER-CMU`](../../../bibliography.md#SRC-JUNGER-CMU): Junger v. Daley Opinion Text (CMU).
