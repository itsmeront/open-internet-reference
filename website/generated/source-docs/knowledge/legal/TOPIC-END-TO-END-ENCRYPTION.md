...
- Source path: `knowledge/legal/TOPIC-END-TO-END-ENCRYPTION.md`
- Source ID: `TOPIC-END-TO-END-ENCRYPTION`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/TOPIC-END-TO-END-ENCRYPTION.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+TOPIC-END-TO-END-ENCRYPTION)
...
[^1]: [`SRC-SIGNAL-HOME`](https://signal.org/) — Signal Official Website. Official organization page.
[^2]: [`SRC-WYDEN-EARN-IT`](../../../bibliography.md#SRC-WYDEN-EARN-IT) — Wyden press release on EARN IT Act. Official Senate press release.
[^3]: [`SRC-LEE-ENCRYPTION-BACKDOORS`](../../../bibliography.md#SRC-LEE-ENCRYPTION-BACKDOORS) — Mike Lee Senate statement (2016). Official Senate page.
[^4]: [`SRC-MASSIE-ENCRYPTION-AMENDMENT`](../../../bibliography.md#SRC-MASSIE-ENCRYPTION-AMENDMENT) — Massie House press release. Official House press release.
[^5]: [`SRC-RFERL-TELEGRAM-BLOCK-2018`](https://www.rferl.org/a/russia-court-orders-telegram-to-be-blocked-in-russia/29164292.html) — RFE/RL report on 2018 Telegram blocking order. Reputable journalism.
[^6]: [`SRC-ZIMMERMANN-BIO`](../../../bibliography.md#SRC-ZIMMERMANN-BIO) — Phil Zimmermann Official Biography. Self-reported profile; investigation outcome corroborated elsewhere.
...
2. [`SRC-WYDEN-EARN-IT`](../../../bibliography.md#SRC-WYDEN-EARN-IT): Wyden on Reintroduction of the EARN IT Act.
3. [`SRC-LEE-ENCRYPTION-BACKDOORS`](../../../bibliography.md#SRC-LEE-ENCRYPTION-BACKDOORS): Encryption backdoors aren't worth the price.
4. [`SRC-MASSIE-ENCRYPTION-AMENDMENT`](../../../bibliography.md#SRC-MASSIE-ENCRYPTION-AMENDMENT): House Passes Massie Amendment to Strengthen Privacy and Security.
5. [`SRC-RFERL-TELEGRAM-BLOCK-2018`](https://www.rferl.org/a/russia-court-orders-telegram-to-be-blocked-in-russia/29164292.html): RFE/RL — Russian Court Orders Telegram App Blocked (2018).
6. [`SRC-ZIMMERMANN-BIO`](../../../bibliography.md#SRC-ZIMMERMANN-BIO): Phil Zimmermann Official Biography.
