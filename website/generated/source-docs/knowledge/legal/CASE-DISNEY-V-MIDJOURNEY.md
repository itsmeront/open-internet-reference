---
id: CASE-DISNEY-V-MIDJOURNEY
title: Disney Enterprises, Inc. v. Midjourney, Inc.
type: case
status: draft
summary: Pending Central District of California copyright action by Disney, Universal, and later-consolidated Warner Bros. Discovery parties alleging that Midjourney copied studio character works to train an image and video generator and that outputs reproduce those characters.
tags:
  - case
  - copyright
...
relationships:
  - subject: CASE-DISNEY-V-MIDJOURNEY
    predicate: cites
    object: SRC-DISNEY-V-MIDJOURNEY-COMPLAINT
    sources:
      - SRC-DISNEY-V-MIDJOURNEY-COMPLAINT
  - subject: CASE-DISNEY-V-MIDJOURNEY
...
- Source path: `knowledge/legal/CASE-DISNEY-V-MIDJOURNEY.md`
- Source ID: `CASE-DISNEY-V-MIDJOURNEY`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/CASE-DISNEY-V-MIDJOURNEY.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+CASE-DISNEY-V-MIDJOURNEY)
...
[^1]: [`SRC-DISNEY-V-MIDJOURNEY-COMPLAINT`](../../../bibliography.md#SRC-DISNEY-V-MIDJOURNEY-COMPLAINT) — Complaint (June 11, 2025). Plaintiff allegations and original parties.

[^2]: [`SRC-DISNEY-V-MIDJOURNEY-MTC-2026`](../../../bibliography.md#SRC-DISNEY-V-MIDJOURNEY-MTC-2026) — Order (June 15, 2026). Primary for consolidation, Warner Bros. Discovery parties, and discovery holdings.

## Historical Context

Disney is the leading Hollywood character-output case. It is adjacent to [Andersen v. Stability AI](CASE-ANDERSEN-V-STABILITY.md), which is an artist class action about training copies and style, but this docket is about recognizable studio characters as outputs of a commercial generator.[^1][^2]

## Legal Analysis

Jurisdiction: Central District of California. Authority level: complaint plus a magistrate discovery order. No source cited here decides [§ 107](STAT-USC-107.md) or substantial similarity on the merits.[^1][^2]
...
- `CASE-DISNEY-V-MIDJOURNEY` cites [`SRC-DISNEY-V-MIDJOURNEY-COMPLAINT`](../../../bibliography.md#SRC-DISNEY-V-MIDJOURNEY-COMPLAINT).
- `CASE-DISNEY-V-MIDJOURNEY` related_to `TOPIC-AI-COPYRIGHT`.
- `CASE-DISNEY-V-MIDJOURNEY` related_to `CASE-ANDERSEN-V-STABILITY`.

## Sources

1. [`SRC-DISNEY-V-MIDJOURNEY-COMPLAINT`](../../../bibliography.md#SRC-DISNEY-V-MIDJOURNEY-COMPLAINT): Disney/Universal complaint (June 11, 2025).
2. [`SRC-DISNEY-V-MIDJOURNEY-MTC-2026`](../../../bibliography.md#SRC-DISNEY-V-MIDJOURNEY-MTC-2026): Order on motion to compel (June 15, 2026).
