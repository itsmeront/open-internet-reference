---
id: CASE-THOMSON-REUTERS-V-ROSS
title: Thomson Reuters Enterprise Centre GmbH v. Ross Intelligence Inc.
type: case
status: draft
summary: Thomson Reuters v. Ross Intelligence (D. Del. Feb. 11, 2025) rejected a fair-use defense for using Westlaw headnotes to train a competing non-generative legal-research AI tool.
tags:
  - case
  - copyright
...
sources:
  ...
  - SRC-USC-17-107-LII
relationships:
  - subject: CASE-THOMSON-REUTERS-V-ROSS
    predicate: cites
    object: SRC-THOMSON-REUTERS-V-ROSS-2025
    sources:
      - SRC-THOMSON-REUTERS-V-ROSS-2025
  - subject: CASE-THOMSON-REUTERS-V-ROSS
...
- Source path: `knowledge/legal/CASE-THOMSON-REUTERS-V-ROSS.md`
- Source ID: `CASE-THOMSON-REUTERS-V-ROSS`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/legal/CASE-THOMSON-REUTERS-V-ROSS.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+CASE-THOMSON-REUTERS-V-ROSS)
...
- The court distinguished intermediate-copying software cases including [Google LLC v. Oracle America, Inc.](CASE-GOOGLE-V-ORACLE.md), on the ground that those cases involved copying necessary for competitors to innovate in computer programs, a factor the court found absent here.[^1]
...
[^1]: [`SRC-THOMSON-REUTERS-V-ROSS-2025`](../../../bibliography.md#SRC-THOMSON-REUTERS-V-ROSS-2025) — Memorandum opinion (Feb. 11, 2025). Primary district-court authority.

## Historical Context

Ross is an earlier AI-training copyright case that does not involve a chatbot that writes new prose. The court flagged that limitation expressly so later readers would not treat the opinion as a holding about generative models.[^1] Generative-training decisions such as [Bartz v. Anthropic PBC](CASE-BARTZ-V-ANTHROPIC.md) and [Kadrey v. Meta Platforms, Inc.](CASE-KADREY-V-META.md) therefore address a different product, even though all three apply § 107.
...
- `CASE-THOMSON-REUTERS-V-ROSS` cites [`SRC-THOMSON-REUTERS-V-ROSS-2025`](../../../bibliography.md#SRC-THOMSON-REUTERS-V-ROSS-2025).
- `CASE-THOMSON-REUTERS-V-ROSS` related_to `STAT-USC-107`.
- `CASE-THOMSON-REUTERS-V-ROSS` related_to `TOPIC-AI-COPYRIGHT`.
- `CASE-THOMSON-REUTERS-V-ROSS` related_to `CASE-GOOGLE-V-ORACLE`.

## Sources

1. [`SRC-THOMSON-REUTERS-V-ROSS-2025`](../../../bibliography.md#SRC-THOMSON-REUTERS-V-ROSS-2025): Thomson Reuters v. Ross Intelligence (D. Del. Feb. 11, 2025).

Additional sources (not yet cited in footnotes):

- [`SRC-USC-17-107-LII`](../../../bibliography.md#SRC-USC-17-107-LII): 17 U.S.C. § 107.
