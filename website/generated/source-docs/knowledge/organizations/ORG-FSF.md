...
type: organization
status: draft
summary: The Free Software Foundation is a 501(c)(3) nonprofit organization founded in 1985 with a worldwide mission to promote computer user freedom and defend the rights of all software users.
tags:
  - organization
...
relationships:
  - subject: ORG-FSF
    predicate: cites
    object: SRC-FSF-ABOUT
    sources:
      - SRC-FSF-ABOUT
  - subject: ORG-FSF
    predicate: cites
    object: SRC-FSF-PRESS
    sources:
      - SRC-FSF-PRESS
...
- Source path: `knowledge/organizations/ORG-FSF.md`
- Source ID: `ORG-FSF`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/organizations/ORG-FSF.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+ORG-FSF)
...
- `ORG-FSF` cites [`SRC-FSF-ABOUT`](../../../bibliography.md#SRC-FSF-ABOUT).
- `ORG-FSF` cites [`SRC-FSF-PRESS`](../../../bibliography.md#SRC-FSF-PRESS).

## Sources

1. [`SRC-FSF-ABOUT`](../../../bibliography.md#SRC-FSF-ABOUT): Free Software Foundation About Page.
2. [`SRC-FSF-PRESS`](../../../bibliography.md#SRC-FSF-PRESS): Free Software Foundation Press Information.
