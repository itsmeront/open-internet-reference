...
- Source path: `knowledge/organizations/ORG-FIRE.md`
- Source ID: `ORG-FIRE`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/organizations/ORG-FIRE.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+ORG-FIRE)
...
[^1]: [`SRC-FIRE-MISSION`](https://www.thefire.org/about-us/mission) — FIRE Mission Page. Official organizational record; self-reported.
[^2]: [`SRC-FIRE-SUBMIT-CASE`](https://www.thefire.org/submit-a-case) — FIRE Submit a Case Page. Official public intake path.
[^3]: [`SRC-FIRE-PRABHAKAR-CASE`](https://www.thefire.org/cases/prabhakar-v-hawkins-et-al) — FIRE Case Page — Prabhakar v. Hawkins et al. Advocacy case page.
...
- `ORG-FIRE` cites [`SRC-FIRE-MISSION`](https://www.thefire.org/about-us/mission).
- `ORG-FIRE` cites [`SRC-FIRE-SUBMIT-CASE`](https://www.thefire.org/submit-a-case).
- `ORG-FIRE` cites [`SRC-FIRE-PRABHAKAR-CASE`](https://www.thefire.org/cases/prabhakar-v-hawkins-et-al).
- `ORG-FIRE` related_to `TOPIC-FIRST-AMENDMENT`.

## Sources

1. [`SRC-FIRE-MISSION`](https://www.thefire.org/about-us/mission): FIRE Mission Page.
2. [`SRC-FIRE-SUBMIT-CASE`](https://www.thefire.org/submit-a-case): FIRE Submit a Case Page.
3. [`SRC-FIRE-PRABHAKAR-CASE`](https://www.thefire.org/cases/prabhakar-v-hawkins-et-al): FIRE Case Page — Prabhakar v. Hawkins et al.
