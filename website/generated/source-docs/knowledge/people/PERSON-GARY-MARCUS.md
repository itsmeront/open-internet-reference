...
- Source path: `knowledge/people/PERSON-GARY-MARCUS.md`
- Source ID: `PERSON-GARY-MARCUS`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/people/PERSON-GARY-MARCUS.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+PERSON-GARY-MARCUS)
...
[^1]: [`SRC-MARCUS-NYU`](../../../bibliography.md#SRC-MARCUS-NYU) — NYU Department of Psychology faculty list. Official university listing.

[^2]: [`SRC-BLUMENTHAL-AI-HEARING-2023`](../../../bibliography.md#SRC-BLUMENTHAL-AI-HEARING-2023) — Official Senate press release on the May 16, 2023 hearing. Press-office excerpt, not a full transcript.

[^3]: [`SRC-MARCUS-HF-LESSONS`](../../../bibliography.md#SRC-MARCUS-HF-LESSONS) — Expert commentary. Opinions about negligence and regulation are the authors'; prefer OpenAI and METR posts for incident mechanics.
...
- `PERSON-GARY-MARCUS` cites [`SRC-MARCUS-NYU`](../../../bibliography.md#SRC-MARCUS-NYU).
- `PERSON-GARY-MARCUS` cites [`SRC-BLUMENTHAL-AI-HEARING-2023`](../../../bibliography.md#SRC-BLUMENTHAL-AI-HEARING-2023).
- `PERSON-GARY-MARCUS` cites [`SRC-MARCUS-HF-LESSONS`](../../../bibliography.md#SRC-MARCUS-HF-LESSONS).
- `PERSON-GARY-MARCUS` related_to `EVENT-OPENAI-HUGGING-FACE-2026`.
- `PERSON-GARY-MARCUS` related_to `PERSON-RICHARD-BLUMENTHAL`.

## Sources

1. [`SRC-MARCUS-NYU`](../../../bibliography.md#SRC-MARCUS-NYU): NYU Department of Psychology faculty list — Gary Marcus.
...
3. [`SRC-MARCUS-HF-LESSONS`](../../../bibliography.md#SRC-MARCUS-HF-LESSONS): 5 lessons from the OpenAI / Hugging Face incident.
