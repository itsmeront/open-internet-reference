...
type: attorney
status: draft
summary: Pamela Chestek is an attorney at Chestek Legal practicing trademark, copyright, open source, and advertising law, and a former Open Source Initiative board member and licensing committee chair.
tags:
  - attorney
...
sources:
  - SRC-CHESTEK-ABOUT
relationships:
  - subject: PERSON-PAMELA-CHESTEK
    predicate: cites
    object: SRC-CHESTEK-ABOUT
    sources:
      - SRC-CHESTEK-ABOUT
...
- Source path: `knowledge/people/PERSON-PAMELA-CHESTEK.md`
- Source ID: `PERSON-PAMELA-CHESTEK`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/people/PERSON-PAMELA-CHESTEK.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+PERSON-PAMELA-CHESTEK)
...
Pamela Chestek is an attorney at Chestek Legal who practices trademark, copyright, open source, advertising, and marketing law. She is a Board Certified Specialist in Trademark Law and former Open Source Initiative board member and licensing committee chair.
...
Chestek is relevant when software projects or companies face trademark disputes in open source communities, license compatibility questions, contributor agreement design, or copyright ownership conflicts. Her OSI licensing committee experience makes her especially useful for license approval strategy and trademark policy in FOSS projects.

## Relationships

- `PERSON-PAMELA-CHESTEK` cites [`SRC-CHESTEK-ABOUT`](../../../bibliography.md#SRC-CHESTEK-ABOUT).
