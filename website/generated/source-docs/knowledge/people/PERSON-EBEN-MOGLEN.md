---
id: PERSON-EBEN-MOGLEN
title: Eben Moglen
type: attorney
status: draft
summary: Eben Moglen is a professor of law at Columbia Law School and founding director of the Software Freedom Law Center, who served as general counsel to the Free Software Foundation and was heavily involved in drafting the GNU General Public License version 3.
tags:
  - attorney
...
relationships:
  - subject: PERSON-EBEN-MOGLEN
    predicate: cites
    object: SRC-MOGLEN-COLUMBIA
    sources:
      - SRC-MOGLEN-COLUMBIA
  - subject: PERSON-EBEN-MOGLEN
    predicate: cites
    object: SRC-MOGLEN-DSI
    sources:
      - SRC-MOGLEN-DSI
  - subject: PERSON-EBEN-MOGLEN
    predicate: cites
...
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/people/PERSON-EBEN-MOGLEN.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+PERSON-EBEN-MOGLEN)
...
[^1]: [`SRC-MOGLEN-COLUMBIA`](../../../bibliography.md#SRC-MOGLEN-COLUMBIA) — Eben Moglen Columbia Law School Faculty Page. Official source.

[^2]: [`SRC-MOGLEN-DSI`](../../../bibliography.md#SRC-MOGLEN-DSI) — Eben Moglen Columbia Data Science Institute Profile. Official institutional profile.

[^3]: [`SRC-ZIMMERMANN-INVESTIGATION-CLOSED`](../../../bibliography.md#SRC-ZIMMERMANN-INVESTIGATION-CLOSED) — EPIC Alert — Charges Dropped Against Phil Zimmermann. Secondary reporting of U.S. Attorney declination.
...
- `PERSON-EBEN-MOGLEN` cites [`SRC-MOGLEN-COLUMBIA`](../../../bibliography.md#SRC-MOGLEN-COLUMBIA).
- `PERSON-EBEN-MOGLEN` cites [`SRC-MOGLEN-DSI`](../../../bibliography.md#SRC-MOGLEN-DSI).
- `PERSON-EBEN-MOGLEN` cites [`SRC-ZIMMERMANN-INVESTIGATION-CLOSED`](../../../bibliography.md#SRC-ZIMMERMANN-INVESTIGATION-CLOSED).
...
2. [`SRC-MOGLEN-DSI`](../../../bibliography.md#SRC-MOGLEN-DSI): Eben Moglen Columbia Data Science Institute Profile.
