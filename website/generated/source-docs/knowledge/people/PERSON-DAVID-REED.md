...
- Source path: `knowledge/people/PERSON-DAVID-REED.md`
- Source ID: `PERSON-DAVID-REED`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/people/PERSON-DAVID-REED.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+PERSON-DAVID-REED)
...
- `PERSON-DAVID-REED` cites [`SRC-REED-BIO`](../../../bibliography.md#SRC-REED-BIO).

## Sources

1. [`SRC-REED-BIO`](../../../bibliography.md#SRC-REED-BIO): David P. Reed Official Biography.
