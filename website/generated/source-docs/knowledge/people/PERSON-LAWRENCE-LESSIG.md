---
id: PERSON-LAWRENCE-LESSIG
title: Lawrence Lessig
type: person
status: draft
summary: Lawrence Lessig is the Roy L. Furman Professor of Law and Leadership at Harvard Law School, founder of Stanford's Center for Internet and Society, and author of foundational works on internet law and free culture including Code and Other Laws of Cyberspace and Free Culture.
tags:
  - person
  - internet-governance
...
sources:
  - SRC-LESSIG-HARVARD
relationships:
  - subject: PERSON-LAWRENCE-LESSIG
    predicate: cites
    object: SRC-LESSIG-HARVARD
    sources:
      - SRC-LESSIG-HARVARD
...
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/people/PERSON-LAWRENCE-LESSIG.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+PERSON-LAWRENCE-LESSIG)
...
[^1]: [`SRC-LESSIG-HARVARD`](../../../bibliography.md#SRC-LESSIG-HARVARD) — Lawrence Lessig Harvard Law School Faculty Page. Official source; review reliability tier.
...
- `PERSON-LAWRENCE-LESSIG` cites [`SRC-LESSIG-HARVARD`](../../../bibliography.md#SRC-LESSIG-HARVARD).
