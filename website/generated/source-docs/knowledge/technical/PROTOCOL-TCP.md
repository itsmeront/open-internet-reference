...
type: protocol
status: draft
summary: Transmission Control Protocol (TCP) is an internet transport protocol specified by RFC 9293.
tags:
...
- [:material-pencil: Edit this page](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/technical/PROTOCOL-TCP.md){ .md-button }  [:material-comment-alert-outline: Suggest a change](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+PROTOCOL-TCP){ .md-button }
...
- `PROTOCOL-TCP` is standardized by [`SRC-RFC-9293`](https://www.rfc-editor.org/rfc/rfc9293.html).

## Sources

- [`SRC-RFC-9293`](https://www.rfc-editor.org/rfc/rfc9293.html): RFC 9293: Transmission Control Protocol (TCP).
