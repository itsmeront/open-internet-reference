...
[^1]: [`SRC-RFC-9293`](https://www.rfc-editor.org/rfc/rfc9293.html) — RFC 9293: Transmission Control Protocol (TCP). Primary authority.
...
1. [`SRC-RFC-9293`](https://www.rfc-editor.org/rfc/rfc9293.html): RFC 9293: Transmission Control Protocol (TCP).
