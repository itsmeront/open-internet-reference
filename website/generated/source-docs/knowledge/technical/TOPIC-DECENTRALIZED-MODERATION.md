...
- Source path: `knowledge/technical/TOPIC-DECENTRALIZED-MODERATION.md`
- Source ID: `TOPIC-DECENTRALIZED-MODERATION`
- [**Edit this page**](https://github.com/itsmeront/open-internet-reference/edit/main/knowledge/technical/TOPIC-DECENTRALIZED-MODERATION.md) | [**Suggest a change**](https://github.com/itsmeront/open-internet-reference/issues/new?template=suggest-edit.yml&title=Edit+suggestion:+TOPIC-DECENTRALIZED-MODERATION)
...
[^1]: [`SRC-HYPHANET-WOT-README`](https://github.com/hyphanet/plugin-WebOfTrust/blob/next/README.md) — Hyphanet Web of Trust Plugin README. Official developer documentation.
[^2]: [`SRC-DRAKETO-WOT-FRIENDLY-2018`](https://www.draketo.de/english/freenet/friendly-communication-with-anonymity) — Arne Babenhauserheide essay. Contributor historical account and evaluation.
[^3]: [`SRC-DRAKETO-DECENTRALIZED-MODERATION`](https://www.draketo.de/software/decentralized-moderation) — Arne Babenhauserheide decentralized moderation note. Contributor commentary.
[^4]: [`SRC-HYPHANET-HOME`](https://www.hyphanet.org/) — Hyphanet Home Page. Official project page.
[^5]: [`SRC-GUARDIAN-FREENET-DARK-SIDE-2009`](https://www.theguardian.com/technology/2009/nov/26/dark-side-internet-freenet) — The Guardian (2009). Reputable journalism with attributed quotation.
[^6]: [`SRC-LWN-GNUNET-INTRO-2005`](https://lwn.net/Articles/162190/) — LWN.net (2005). Technical journalism.
[^7]: [`SRC-GNUNET-ABOUT`](https://www.gnunet.org/en/about.html) — GNUnet About Page. Official project page.
...
- `TOPIC-DECENTRALIZED-MODERATION` cites [`SRC-HYPHANET-WOT-README`](https://github.com/hyphanet/plugin-WebOfTrust/blob/next/README.md).
- `TOPIC-DECENTRALIZED-MODERATION` cites [`SRC-DRAKETO-WOT-FRIENDLY-2018`](https://www.draketo.de/english/freenet/friendly-communication-with-anonymity).

## Sources

1. [`SRC-HYPHANET-WOT-README`](https://github.com/hyphanet/plugin-WebOfTrust/blob/next/README.md): Hyphanet Web of Trust Plugin README.
2. [`SRC-DRAKETO-WOT-FRIENDLY-2018`](https://www.draketo.de/english/freenet/friendly-communication-with-anonymity): Arne Babenhauserheide — Hyphanet Web of Trust Keeps Communication Friendly.
3. [`SRC-DRAKETO-DECENTRALIZED-MODERATION`](https://www.draketo.de/software/decentralized-moderation): Arne Babenhauserheide — The Path Towards Decentralized Moderation.
4. [`SRC-HYPHANET-HOME`](https://www.hyphanet.org/): Hyphanet Home Page.
5. [`SRC-GUARDIAN-FREENET-DARK-SIDE-2009`](https://www.theguardian.com/technology/2009/nov/26/dark-side-internet-freenet): The Guardian — The Dark Side of the Internet (2009).
6. [`SRC-LWN-GNUNET-INTRO-2005`](https://lwn.net/Articles/162190/): LWN.net — An Introduction to GNUnet (2005).
7. [`SRC-GNUNET-ABOUT`](https://www.gnunet.org/en/about.html): GNUnet About Page.
