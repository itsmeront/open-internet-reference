...
def timeline_payload(records: list[dict[str, Any]]) -> dict[str, Any]:
    return {
        ...
        "description": (
            ...
            "enactment_date, and legislative_override_date. Document publication "
            "and verification dates appear on individual page footers instead."
        ),
...
def write_timeline_markdown(
    ...
    lines = [
        ...
        (
            ...
            "`legislative_override_date`, and `event_date`). Document publication "
