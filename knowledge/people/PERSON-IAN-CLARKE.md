...
[^1]: `SRC-CLARKE-FREENET-BIO` — Ian Clarke Freenet Project Biography. Self-reported project biography; corroboration pending for nonprofit status and download counts.
[^2]: `SRC-CLARKE-DDISRS-1999` — A Distributed Decentralised Information Storage and Retrieval System. Primary undergraduate research report.
[^3]: `SRC-CLARKE-FREENET-PAPER-2001` — Freenet workshop paper (2001). Primary academic design paper.
[^4]: `SRC-FREENET-HISTORY` — Freenet History Page. Official organization page for the post-2023 Freenet project.
[^5]: `SRC-HYPHANET-RENAME` — Freenet Renamed to Hyphanet. Official Hyphanet announcement.
[^6]: `SRC-GUARDIAN-FREENET-DARK-SIDE-2009` — The Guardian (2009). Reputable journalism with attributed quotation.
[^7]: `SRC-TR-IAN-CLARKE` — MIT Technology Review innovator profile. Secondary reporting.
...
- `PERSON-IAN-CLARKE` authored `SRC-CLARKE-DDISRS-1999`.
- `PERSON-IAN-CLARKE` authored `SRC-CLARKE-FREENET-PAPER-2001`.
- `PERSON-IAN-CLARKE` related_to `TECH-HYPHANET`.
- `PERSON-IAN-CLARKE` related_to `TOPIC-DECENTRALIZED-MODERATION`.

## Sources

1. `SRC-CLARKE-FREENET-BIO`: Ian Clarke — Freenet Project Biography.
2. `SRC-CLARKE-DDISRS-1999`: A Distributed Decentralised Information Storage and Retrieval System.
3. `SRC-CLARKE-FREENET-PAPER-2001`: Freenet: A Distributed Anonymous Information Storage and Retrieval System (2001).
4. `SRC-FREENET-HISTORY`: Freenet History Page.
5. `SRC-HYPHANET-RENAME`: Freenet Renamed to Hyphanet.
6. `SRC-GUARDIAN-FREENET-DARK-SIDE-2009`: The Guardian — The Dark Side of the Internet (2009).
7. `SRC-TR-IAN-CLARKE`: MIT Technology Review — Ian Clarke Innovator Profile.
