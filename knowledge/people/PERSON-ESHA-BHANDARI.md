...
[^1]: `SRC-BHANDARI-ACLU` — Esha Bhandari ACLU Staff Biography. Self-reported profile; corroboration pending.
...
- `PERSON-ESHA-BHANDARI` cites `SRC-BHANDARI-ACLU`.
- `PERSON-ESHA-BHANDARI` affiliated_with `ORG-ACLU`.

## Sources

1. `SRC-BHANDARI-ACLU`: Esha Bhandari ACLU Staff Biography.
