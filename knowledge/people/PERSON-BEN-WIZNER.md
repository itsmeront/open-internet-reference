...
[^1]: `SRC-WIZNER-ACLU` — Ben Wizner ACLU Staff Biography. Self-reported profile; corroboration pending.
...
- `PERSON-BEN-WIZNER` cites `SRC-WIZNER-ACLU`.
- `PERSON-BEN-WIZNER` affiliated_with `ORG-ACLU`.

## Sources

- `SRC-WIZNER-ACLU`: Ben Wizner ACLU Staff Biography.
