...
[^1]: `SRC-CHESTEK-ABOUT` — Pamela Chestek About Page. Self-reported profile; corroboration pending.
...
- `PERSON-PAMELA-CHESTEK` cites `SRC-CHESTEK-ABOUT`.

## Sources

1. `SRC-CHESTEK-ABOUT`: Pamela Chestek About Page.
