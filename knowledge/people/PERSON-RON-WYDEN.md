...
type: person
status: draft
summary: Ron Wyden is a U.S. Senator from Oregon who co-authored Section 230 of the Communications Decency Act, champions encryption and privacy rights, and has introduced legislation including Aaron's Law (CFAA reform), the Fourth Amendment Is Not For Sale Act, and the USA RIGHTS Act.
tags:
  - person
  - internet-governance
  - digital-rights
...
[^1]: `SRC-WYDEN-SECTION-230` — Wyden Remarks at Section 230 Briefing Hosted by EFF. Official Senate press release.

[^2]: `SRC-WYDEN-AARONS-LAW` — Wyden Introduces Reforms to the Computer Fraud and Abuse Act. Official Senate press release.
...
[^5]: `SRC-WYDEN-EARN-IT` — Wyden on Reintroduction of the EARN IT Act. Official Senate press release.
...
- `PERSON-RON-WYDEN` cites `SRC-WYDEN-SECTION-230`.
- `PERSON-RON-WYDEN` cites `SRC-WYDEN-AARONS-LAW`.
- `PERSON-RON-WYDEN` cites `SRC-WYDEN-FOURTH-AMENDMENT-NOT-FOR-SALE`.
- `PERSON-RON-WYDEN` cites `SRC-WYDEN-USA-RIGHTS-ACT`.
- `PERSON-RON-WYDEN` cites `SRC-WYDEN-EARN-IT`.

## Sources

1. `SRC-WYDEN-SECTION-230`: Wyden Remarks at Section 230 Briefing Hosted by EFF.
2. `SRC-WYDEN-AARONS-LAW`: Wyden Introduces Reforms to the Computer Fraud and Abuse Act.
...
5. `SRC-WYDEN-EARN-IT`: Wyden on Reintroduction of the EARN IT Act.
