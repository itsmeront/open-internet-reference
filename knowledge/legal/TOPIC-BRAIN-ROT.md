...
[^1]: `SRC-OXFORD-BRAIN-ROT-WOTY-2024` — Oxford University Press Word of the Year 2024 announcement. Official lexicographic source.

[^2]: `SRC-SPYDER-V-MEMENTUM-COMPLAINT` — Spyder Games LLC v. Mementum Lab complaint (N.D. Cal. Nov. 26, 2025). Plaintiff allegations; not findings of fact.

[^3]: `SRC-THALER-V-PERLMUTTER-CADC` — Thaler v. Perlmutter, 130 F.4th 1039 (D.C. Cir. 2025). Primary appellate authority.

[^4]: `SRC-USCO-AI-REGISTRATION-GUIDANCE-2023` — 88 Fed. Reg. 16190 (Mar. 16, 2023). Agency registration guidance.

[^5]: `SRC-USCO-AI-COPYRIGHTABILITY-REPORT-2025` — Copyright Office, Copyright and Artificial Intelligence, Part 2 (Jan. 2025). Agency report; not a judicial holding.

[^6]: `SRC-SPYDER-V-MEMENTUM-DOCKET` — CourtListener docket for No. 5:25-cv-10248. Procedural record.
