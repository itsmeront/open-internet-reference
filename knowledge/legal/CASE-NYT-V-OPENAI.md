...
The Times action is the highest-profile news-publisher suit in the generative-AI copyright wave. Unlike [Bartz v. Anthropic PBC](CASE-BARTZ-V-ANTHROPIC.md) and [Kadrey v. Meta Platforms, Inc.](CASE-KADREY-V-META.md), which reached summary judgment on book-training fair use, this docket remained at pleadings and discovery as of the August 2026 order, with output substitution and training still live issues for remaining claims.[^2][^3]
...
- Document consolidation/MDL captioning (RECAP numbers differ across related dockets).
...
- Getty Images v. Stability AI, Authors Guild/OpenAI book cases, and Disney/Midjourney remain separate research-debt case pages.
