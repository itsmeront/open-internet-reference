...
- `CASE-BROWN-V-ENTERTAINMENT-MERCHANTS` cites `SRC-BROWN-V-EMA-LII`.
- `CASE-BROWN-V-ENTERTAINMENT-MERCHANTS` cites `SRC-BROWN-V-EMA-GOVINFO`.
...
- `SRC-BROWN-V-EMA-GOVINFO`: Brown v. Entertainment Merchants Assn., 564 U.S. 786 (2011) (GovInfo).
