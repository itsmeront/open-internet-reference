...
[^1]: `SRC-DISNEY-V-MIDJOURNEY-COMPLAINT` — Complaint (June 11, 2025). Plaintiff allegations and original parties.

[^2]: `SRC-DISNEY-V-MIDJOURNEY-MTC-2026` — Order (June 15, 2026). Primary for consolidation, Warner Bros. Discovery parties, and discovery holdings.
...
- `CASE-DISNEY-V-MIDJOURNEY` cites `SRC-DISNEY-V-MIDJOURNEY-COMPLAINT`.
- `CASE-DISNEY-V-MIDJOURNEY` related_to `TOPIC-AI-COPYRIGHT`.
- `CASE-DISNEY-V-MIDJOURNEY` related_to `CASE-ANDERSEN-V-STABILITY`.

## Sources

1. `SRC-DISNEY-V-MIDJOURNEY-COMPLAINT`: Disney/Universal complaint (June 11, 2025).
2. `SRC-DISNEY-V-MIDJOURNEY-MTC-2026`: Order on motion to compel (June 15, 2026).
