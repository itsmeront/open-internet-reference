...
[^1]: `SRC-VAN-LOON-5TH-CIR-JUSTIA` — Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024) (Justia). Primary authority.
...
[^3]: `SRC-TREASURY-TC-NOV-2022` — Treasury Designates DPRK Weapons Representatives; Tornado Cash Redesignation (Nov. 8, 2022). Official government press release.
[^4]: `SRC-TREASURY-TC-DELIST-2025` — Tornado Cash Delisting (Mar. 21, 2025). Official government press release.
[^5]: `SRC-OFAC-TC-REMOVAL-20250321` — OFAC Recent Actions — Cyber-related Designation Removal (Mar. 21, 2025). Official OFAC notice.
[^6]: `SRC-IEEPA-50-USC-1702-LII` — 50 U.S.C. § 1702 (Cornell LII). Statute text.
...
- `CASE-VAN-LOON-V-TREASURY` cites `SRC-VAN-LOON-5TH-CIR-JUSTIA`.
...
1. `SRC-VAN-LOON-5TH-CIR-JUSTIA`: Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024) (Justia).
2. `SRC-TREASURY-TC-AUG-2022`: U.S. Treasury Sanctions Notorious Virtual Currency Mixer Tornado Cash (Aug. 8, 2022).
3. `SRC-TREASURY-TC-NOV-2022`: Treasury Designates DPRK Weapons Representatives; Tornado Cash Redesignation (Nov. 8, 2022).
4. `SRC-TREASURY-TC-DELIST-2025`: Tornado Cash Delisting (Mar. 21, 2025).
5. `SRC-OFAC-TC-REMOVAL-20250321`: OFAC Recent Actions — Cyber-related Designation Removal (Mar. 21, 2025).
6. `SRC-IEEPA-50-USC-1702-LII`: 50 U.S.C. § 1702 (Cornell LII).
