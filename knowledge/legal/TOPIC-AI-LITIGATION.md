...
[^15]: `SRC-SONY-V-ANTHROPIC-COMPLAINT-2026` — N.D. Cal. Aug. 28, 2026. Pending; allegations.

[^16]: `SRC-ANDERSEN-V-STABILITY-MTD-2024` — N.D. Cal. Aug. 12, 2024.

[^17]: `SRC-DISNEY-V-MIDJOURNEY-COMPLAINT` — C.D. Cal. June 11, 2025. Pending.

[^18]: `SRC-DISNEY-V-MIDJOURNEY-MTC-2026` — C.D. Cal. June 15, 2026.

[^19]: `SRC-GETTY-V-STABILITY-EWHC-2025` — [2025] EWHC 2863 (Ch).

[^20]: `SRC-DOE-V-GITHUB-MTD-2024` — N.D. Cal. June 24, 2024.

[^21]: `SRC-DOE-V-GITHUB-9THCIR-DOCKET` — 9th Cir. No. 24-7700.

[^22]: `SRC-JPML-OPENAI-MDL-3143` — JPML Transfer Order, MDL No. 3143.

[^23]: `SRC-IN-RE-OPENAI-OUTPUT-MTD-2025` — S.D.N.Y. Oct. 27, 2025.

[^24]: `SRC-DOW-JONES-V-PERPLEXITY-MTD-2025` — S.D.N.Y. Aug. 21, 2025.

[^25]: `SRC-CONCORD-II-COMPLAINT` — N.D. Cal. Jan. 28, 2026. Pending; allegations.

[^26]: `SRC-BMG-V-ANTHROPIC-COMPLAINT` — N.D. Cal. Mar. 17, 2026. Pending; allegations.

[^27]: `SRC-GETTY-V-STABILITY-US-MTD-2026` — N.D. Cal. Apr. 23, 2026.

[^28]: `SRC-KNESCHKE-LG-HAMBURG-2024` — LG Hamburg, 310 O 227/23 (Sept. 27, 2024).

[^29]: `SRC-KNESCHKE-OLG-HAMBURG-2025` — OLG Hamburg, 5 U 104/24 (Dec. 10, 2025).

[^30]: `SRC-GOOGLE-GEN-AI-MTD-2025` — N.D. Cal. Sept. 11, 2025.

[^31]: `SRC-RAINE-V-OPENAI-COMPLAINT` — Cal. Super. Ct. Aug. 26, 2025. Pending; allegations. See also `SRC-TJLP-JCCP-5431-2026` and `SRC-LYONS-V-OPENAI-MTD-2026` for JCCP 5431.

[^32]: `SRC-LYONS-V-OPENAI-MTD-2026` — N.D. Cal. Apr. 13, 2026. Colorado River stay denied.

[^33]: `SRC-JOSHI-V-OPENAI-COMPLAINT` — N.D. Fla. May 10, 2026. Pending; allegations.

[^34]: `SRC-FLORIDA-V-OPENAI-COMPLAINT` — Fla. 10th Cir. Ct. June 1, 2026. Pending; allegations.

[^35]: `SRC-WALTERS-V-OPENAI-SJ-2025` — Ga. Super. Ct. May 19, 2025.
...
15. `SRC-SONY-V-ANTHROPIC-COMPLAINT-2026`: Sony/Warner publisher complaint (2026).
16. `SRC-ANDERSEN-V-STABILITY-MTD-2024`: Andersen MTD order (2024).
17. `SRC-DISNEY-V-MIDJOURNEY-COMPLAINT`: Disney complaint (2025).
18. `SRC-DISNEY-V-MIDJOURNEY-MTC-2026`: Disney discovery order (2026).
19. `SRC-GETTY-V-STABILITY-EWHC-2025`: Getty UK judgment (2025).
20. `SRC-DOE-V-GITHUB-MTD-2024`: Doe v. GitHub MTD order (2024).
21. `SRC-DOE-V-GITHUB-9THCIR-DOCKET`: Doe Ninth Circuit docket.
22. `SRC-JPML-OPENAI-MDL-3143`: JPML Transfer Order, MDL No. 3143.
...
27. `SRC-GETTY-V-STABILITY-US-MTD-2026`: Getty U.S. MTD order (2026).
28. `SRC-KNESCHKE-LG-HAMBURG-2024`: Kneschke LG Hamburg (2024).
29. `SRC-KNESCHKE-OLG-HAMBURG-2025`: Kneschke OLG Hamburg (2025).
30. `SRC-GOOGLE-GEN-AI-MTD-2025`: In re Google Generative AI MTD order (2025).
31. `SRC-RAINE-V-OPENAI-COMPLAINT`: Raine complaint (2025).
32. `SRC-LYONS-V-OPENAI-MTD-2026`: Lyons Colorado River order (2026).
33. `SRC-JOSHI-V-OPENAI-COMPLAINT`: Joshi complaint (2026).
34. `SRC-FLORIDA-V-OPENAI-COMPLAINT`: Florida AG civil complaint (2026).
35. `SRC-WALTERS-V-OPENAI-SJ-2025`: Walters summary-judgment order (2025).
36. `SRC-TJLP-JCCP-5431-2026`: Tech Justice JCCP update (2026).
