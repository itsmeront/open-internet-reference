...
[^1]: `SRC-IEEPA-50-USC-1702-LII` — 50 U.S.C. § 1702 (Cornell LII). Statute text.
[^2]: `SRC-VAN-LOON-5TH-CIR-JUSTIA` — Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024) (Justia). Primary authority.
...
- `STAT-IEEPA` cites `SRC-IEEPA-50-USC-1702-LII`.
- `STAT-IEEPA` related_to `CASE-VAN-LOON-V-TREASURY`.
- `STAT-IEEPA` related_to `TOPIC-TORNADO-CASH`.

## Sources

1. `SRC-IEEPA-50-USC-1702-LII`: 50 U.S.C. § 1702 (Cornell LII).
2. `SRC-VAN-LOON-5TH-CIR-JUSTIA`: Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024) (Justia).
