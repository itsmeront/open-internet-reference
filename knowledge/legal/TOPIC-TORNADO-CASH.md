...
[^1]: `SRC-TREASURY-TC-AUG-2022` — U.S. Treasury Sanctions Notorious Virtual Currency Mixer Tornado Cash (Aug. 8, 2022). Official government press release.
[^2]: `SRC-TREASURY-TC-NOV-2022` — Treasury Designates DPRK Weapons Representatives; Tornado Cash Redesignation (Nov. 8, 2022). Official government press release.
[^3]: `SRC-OFAC-FAQ-1076` — OFAC FAQ 1076. Official OFAC FAQ.
[^4]: `SRC-VAN-LOON-5TH-CIR-JUSTIA` — Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024) (Justia). Primary authority.
[^5]: `SRC-COIN-CENTER-YELLEN-NDFLA-2023` — Coin Center v. Yellen, No. 3:22-cv-20375 (N.D. Fla. Oct. 30, 2023). Primary authority.
[^6]: `SRC-TREASURY-TC-DELIST-2025` — Tornado Cash Delisting (Mar. 21, 2025). Official government press release.
[^7]: `SRC-TREASURY-SEMENOV-2023` — Treasury Designates Roman Semenov (Aug. 23, 2023). Official government press release.
[^8]: `SRC-DOJ-STORM-INDICTMENT` — United States v. Storm / Semenov Indictment (S.D.N.Y. Aug. 2023). Charging instrument.
[^9]: `SRC-DOJ-STORM-CONVICTION-2025` — SDNY National Security Page — Roman Storm Conviction Note (Aug. 2025). Official USAO summary.
[^10]: `SRC-PERTSEV-ECLI-2024` — ECLI:NL:RBOBR:2024:2069 (May 14, 2024). Primary authority.
[^11]: `SRC-PERTSEV-RECHTSPRAAK-EN-2024` — Dutch Judiciary English News — Tornado Cash Developer Jail Sentence (May 2024). Official court news summary.
[^12]: `SRC-IEEPA-50-USC-1702-LII` — 50 U.S.C. § 1702 (Cornell LII). Statute text.
...
- `TOPIC-TORNADO-CASH` cites `SRC-VAN-LOON-5TH-CIR-JUSTIA`.
...
1. `SRC-TREASURY-TC-AUG-2022`: U.S. Treasury Sanctions Notorious Virtual Currency Mixer Tornado Cash (Aug. 8, 2022).
2. `SRC-TREASURY-TC-NOV-2022`: Treasury Designates DPRK Weapons Representatives; Tornado Cash Redesignation (Nov. 8, 2022).
3. `SRC-OFAC-FAQ-1076`: OFAC FAQ 1076.
4. `SRC-VAN-LOON-5TH-CIR-JUSTIA`: Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024) (Justia).
5. `SRC-COIN-CENTER-YELLEN-NDFLA-2023`: Coin Center v. Yellen, No. 3:22-cv-20375 (N.D. Fla. Oct. 30, 2023).
6. `SRC-TREASURY-TC-DELIST-2025`: Tornado Cash Delisting (Mar. 21, 2025).
7. `SRC-TREASURY-SEMENOV-2023`: Treasury Designates Roman Semenov (Aug. 23, 2023).
8. `SRC-DOJ-STORM-INDICTMENT`: United States v. Storm / Semenov Indictment (S.D.N.Y. Aug. 2023).
9. `SRC-DOJ-STORM-CONVICTION-2025`: SDNY National Security Page — Roman Storm Conviction Note (Aug. 2025).
10. `SRC-PERTSEV-ECLI-2024`: ECLI:NL:RBOBR:2024:2069 (May 14, 2024).
11. `SRC-PERTSEV-RECHTSPRAAK-EN-2024`: Dutch Judiciary English News — Tornado Cash Developer Jail Sentence (May 2024).
12. `SRC-IEEPA-50-USC-1702-LII`: 50 U.S.C. § 1702 (Cornell LII).

Additional sources (not yet cited in footnotes):

- `SRC-OFAC-TC-REMOVAL-20250321`: OFAC Recent Actions — Cyber-related Designation Removal (Mar. 21, 2025).
- `SRC-FBI-SEMENOV`: FBI Wanted — Roman Semenov.
