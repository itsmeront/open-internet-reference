...
[^1]: `SRC-UMG-V-SUNO-COMPLAINT` — Suno complaint (June 24, 2024).

[^2]: `SRC-UMG-V-SUNO-ANSWER` — Suno answer (Aug. 1, 2024).

[^3]: `SRC-UMG-V-SUNO-WARNER-DISMISSAL` — Warner stipulation (Dec. 9, 2025).

[^4]: `SRC-UMG-V-UDIO-COMPLAINT` — Udio complaint (June 2024).

[^5]: `SRC-UMG-V-UDIO-DOCKET` — Udio docket, including 2025 dismissals.

[^6]: `SRC-SONY-V-UDIO-2026-COMPLAINT` — Sony follow-on complaint (July 20, 2026).

[^7]: `SRC-CONCORD-V-ANTHROPIC-MTD-2025` — Concord order denying MTD (Oct. 6, 2025).

[^8]: `SRC-GEMA-V-OPENAI-LG-MUENCHEN-2025` — LG München I judgment (Nov. 11, 2025).

[^9]: `SRC-GEMA-V-OPENAI-PRESS-2025` — Official press release (Nov. 11, 2025).

[^10]: `SRC-USC-17-107-LII` — 17 U.S.C. § 107.

[^11]: `SRC-SONY-V-ANTHROPIC-COMPLAINT-2026` — Sony/Warner publisher complaint (Aug. 28, 2026). Pending; allegations.

[^12]: `SRC-CONCORD-II-COMPLAINT` — Concord II complaint (Jan. 28, 2026). Pending; allegations.

[^13]: `SRC-CONCORD-II-RELATED-2026` — Related-case order (Feb. 18, 2026).

[^14]: `SRC-BMG-V-ANTHROPIC-COMPLAINT` — BMG complaint (Mar. 17, 2026). Pending; allegations.
...
1. `SRC-UMG-V-SUNO-COMPLAINT`: Suno complaint (2024).
2. `SRC-UMG-V-SUNO-ANSWER`: Suno answer (2024).
3. `SRC-UMG-V-SUNO-WARNER-DISMISSAL`: Warner Suno dismissal (2025).
4. `SRC-UMG-V-UDIO-COMPLAINT`: Udio complaint (2024).
5. `SRC-UMG-V-UDIO-DOCKET`: Udio docket and dismissals.
6. `SRC-SONY-V-UDIO-2026-COMPLAINT`: Sony second Udio complaint (2026).
7. `SRC-CONCORD-V-ANTHROPIC-MTD-2025`: Concord MTD denial (2025).
8. `SRC-GEMA-V-OPENAI-LG-MUENCHEN-2025`: Munich judgment (2025).
9. `SRC-GEMA-V-OPENAI-PRESS-2025`: Munich press release (2025).
10. `SRC-USC-17-107-LII`: 17 U.S.C. § 107.
11. `SRC-SONY-V-ANTHROPIC-COMPLAINT-2026`: Sony/Warner publisher complaint (2026).
12. `SRC-CONCORD-II-COMPLAINT`: Concord II complaint (2026).
13. `SRC-CONCORD-II-RELATED-2026`: Concord II related-case order (2026).
14. `SRC-BMG-V-ANTHROPIC-COMPLAINT`: BMG v. Anthropic complaint (2026).
