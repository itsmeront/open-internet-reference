---
id: CASE-WALTERS-V-OPENAI
title: Walters v. OpenAI, L.L.C.
type: case
status: draft
summary: Gwinnett County, Georgia defamation action over a ChatGPT hallucination; on May 19, 2025, the court granted OpenAI summary judgment on three independent grounds.
tags:
  - case
  - first-amendment
...
relationships:
  - subject: CASE-WALTERS-V-OPENAI
    predicate: cites
    object: SRC-WALTERS-V-OPENAI-SJ-2025
    sources:
      - SRC-WALTERS-V-OPENAI-SJ-2025
  - subject: CASE-WALTERS-V-OPENAI
...
[^1]: `SRC-WALTERS-V-OPENAI-SJ-2025` — Summary-judgment order (May 19, 2025). Primary trial-court authority; not appellate precedent.

## Historical Context

Walters is among the first U.S. merits dispositions of a ChatGPT “hallucination” libel claim. It is a reputational-harm case, not a physical-injury product-liability suit, but it is the decided counterpart to the still-pending chatbot-harm inventory on [Chatbot Product Liability and User-Harm Litigation](TOPIC-AI-HARM-LITIGATION.md).
...
- `CASE-WALTERS-V-OPENAI` cites `SRC-WALTERS-V-OPENAI-SJ-2025`.
- `CASE-WALTERS-V-OPENAI` related_to `TOPIC-AI-HARM-LITIGATION`.
- `CASE-WALTERS-V-OPENAI` related_to `TOPIC-AI-LITIGATION`.
- `CASE-WALTERS-V-OPENAI` related_to `TOPIC-FIRST-AMENDMENT`.

## Sources

1. `SRC-WALTERS-V-OPENAI-SJ-2025`: Summary-judgment order (May 19, 2025).
