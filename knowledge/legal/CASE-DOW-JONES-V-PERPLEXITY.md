---
id: CASE-DOW-JONES-V-PERPLEXITY
title: Dow Jones & Co. v. Perplexity AI, Inc.
type: case
status: draft
summary: Pending Southern District of New York copyright and trademark action by the Wall Street Journal and New York Post against Perplexity’s answer engine; the court denied motions to dismiss for lack of jurisdiction and improper venue. Related Times and Tribune actions against Perplexity were later filed in the same district.
tags:
  - case
  - copyright
...
sources:
  ...
  - SRC-DOW-JONES-V-PERPLEXITY-DOCKET
  - SRC-NYT-V-PERPLEXITY-DOCKET
relationships:
  - subject: CASE-DOW-JONES-V-PERPLEXITY
    predicate: cites
    object: SRC-DOW-JONES-V-PERPLEXITY-MTD-2025
    sources:
      - SRC-DOW-JONES-V-PERPLEXITY-MTD-2025
  - subject: CASE-DOW-JONES-V-PERPLEXITY
...
This docket is the leading news-publisher case against a retrieval-augmented answer engine rather than a closed chatbot trained only on a static corpus. It is adjacent to [Times v. OpenAI](CASE-NYT-V-OPENAI.md) but names a different defendant and emphasizes real-time crawling plus generated answers.[^1]

## Legal Analysis

Jurisdiction: Southern District of New York. Authority level: personal-jurisdiction, venue, and § 411(a) pleading order. The court did not decide [§ 107](STAT-USC-107.md) or substantial similarity on the merits.[^1]
