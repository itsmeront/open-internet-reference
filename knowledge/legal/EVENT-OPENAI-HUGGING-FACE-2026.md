...
[^1]: `SRC-HF-SECURITY-INCIDENT-JULY-2026` — Hugging Face official disclosure (July 16, 2026).

[^2]: `SRC-HF-AGENT-INTRUSION-TIMELINE` — Hugging Face technical timeline (July 27, 2026).

[^3]: `SRC-OPENAI-HF-INCIDENT-JULY-2026` — OpenAI first attribution (July 21, 2026).

[^4]: `SRC-OPENAI-HF-ROAD-AHEAD` — OpenAI findings summary (August 26, 2026). Company statements on impact and causation.

[^5]: `SRC-METR-HF-INVESTIGATION` — METR/Redwood independent writeup (August 26, 2026). Scoped investigation with possible redactions.

[^6]: `SRC-MARCUS-HF-LESSONS` — Expert commentary (August 28, 2026). Opinions attributed to the authors.
...
- `EVENT-OPENAI-HUGGING-FACE-2026` cites `SRC-HF-SECURITY-INCIDENT-JULY-2026`.
...
1. `SRC-HF-SECURITY-INCIDENT-JULY-2026`: Hugging Face — Security incident disclosure (July 2026).
2. `SRC-HF-AGENT-INTRUSION-TIMELINE`: Hugging Face — Anatomy of a Frontier Lab Agent Intrusion.
3. `SRC-OPENAI-HF-INCIDENT-JULY-2026`: OpenAI — Hugging Face model-evaluation security incident (July 21, 2026).
4. `SRC-OPENAI-HF-ROAD-AHEAD`: OpenAI — The Hugging Face incident and the road ahead.
