...
[^1]: `SRC-GOOGLE-ORACLE-JUSTIA` — Google LLC v. Oracle America, Inc., 593 U.S. ___ (2021) (Justia). Primary authority.
...
- `CASE-GOOGLE-V-ORACLE` cites `SRC-GOOGLE-ORACLE-JUSTIA`.
- `CASE-GOOGLE-V-ORACLE` related_to `TOPIC-CODE-AS-SPEECH`.

## Sources

1. `SRC-GOOGLE-ORACLE-JUSTIA`: Google LLC v. Oracle America, Inc., 593 U.S. ___ (2021) (Justia).
