...
[^1]: `SRC-UMG-V-UDIO-COMPLAINT` — Original complaint (June 24/25, 2024). Plaintiff allegations except as to caption and claims pleaded.

[^2]: `SRC-UMG-V-UDIO-DOCKET` — CourtListener docket for No. 1:24-cv-04777. Primary for filing dates and dismissal stipulations.

[^3]: `SRC-SONY-V-UDIO-2026-COMPLAINT` — Second Sony complaint (July 20, 2026). Plaintiff allegations; the June 29, 2026 leave-to-amend ruling is quoted from that complaint.
...
- `CASE-UMG-V-UDIO` cites `SRC-UMG-V-UDIO-COMPLAINT`.
...
1. `SRC-UMG-V-UDIO-COMPLAINT`: Original complaint (June 2024).
2. `SRC-UMG-V-UDIO-DOCKET`: CourtListener docket for No. 1:24-cv-04777.
3. `SRC-SONY-V-UDIO-2026-COMPLAINT`: Sony follow-on complaint (July 20, 2026).
4. `SRC-USC-17-107-LII`: 17 U.S.C. § 107.
