...
[^1]: `SRC-GEMA-V-OPENAI-LG-MUENCHEN-2025` — Official Endurteil report (Nov. 11, 2025). Primary for tenor, headnotes, and appeal caption.
...
- `CASE-GEMA-V-OPENAI` cites `SRC-GEMA-V-OPENAI-LG-MUENCHEN-2025`.
