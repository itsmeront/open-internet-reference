...
[^1]: `SRC-IFS-ABOUT-US` — Institute for Free Speech About Us Page. Self-reported profile; corroboration pending.
...
- `ORG-INSTITUTE-FOR-FREE-SPEECH` cites `SRC-IFS-ABOUT-US`.
