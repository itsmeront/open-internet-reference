...
[^1]: `SRC-TELEGRAM-PRESS` — Telegram Press Info. Official organizational record; self-reported.
[^2]: `SRC-TELEGRAM-FAQ` — Telegram FAQ. Official organizational record; self-reported.
[^3]: `SRC-AP-DUROV-FSB-2026` — AP News — Russia Accuses Telegram CEO Pavel Durov of Aiding Terrorism. Secondary reporting of FSB allegations.
[^4]: `SRC-RFERL-TELEGRAM-BLOCK-2018` — RFE/RL — Russian Court Orders Telegram App Blocked (2018). Secondary reporting.
...
- `ORG-TELEGRAM` cites `SRC-TELEGRAM-PRESS`.
- `ORG-TELEGRAM` cites `SRC-TELEGRAM-FAQ`.
...
2. `SRC-TELEGRAM-FAQ`: Telegram FAQ.
3. `SRC-AP-DUROV-FSB-2026`: AP News — Russia Accuses Telegram CEO Pavel Durov of Aiding Terrorism.
4. `SRC-RFERL-TELEGRAM-BLOCK-2018`: RFE/RL — Russian Court Orders Telegram App Blocked (2018).
