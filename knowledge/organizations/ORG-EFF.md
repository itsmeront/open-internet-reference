...
type: organization
status: draft
summary: Electronic Frontier Foundation is a U.S. nonprofit organization that, according to its official pages, defends civil liberties in the digital world.
tags:
  - organization
  - digital-rights
  - civil-society
...
relationships:
  - subject: ORG-EFF
    predicate: cites
    object: SRC-EFF-CONTACT
    sources:
      - SRC-EFF-CONTACT
  - subject: ORG-EFF
    predicate: cites
    object: SRC-EFF-ABOUT
    sources:
      - SRC-EFF-ABOUT
...
[^1]: `SRC-EFF-CONTACT` — Electronic Frontier Foundation Contact Page. Official organizational record.
[^2]: `SRC-EFF-ABOUT` — Electronic Frontier Foundation About Page. Self-reported profile; corroboration pending.

## Analysis

Analysis has not yet been drafted. Future work should use independent sources to document major litigation, policy work, and technical projects.

## Relationships

- `ORG-EFF` cites `SRC-EFF-CONTACT`.
- `ORG-EFF` cites `SRC-EFF-ABOUT`.

## Sources

1. `SRC-EFF-CONTACT`: Electronic Frontier Foundation Contact Page.
2. `SRC-EFF-ABOUT`: Electronic Frontier Foundation About Page.
