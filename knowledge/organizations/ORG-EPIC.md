...
[^1]: `SRC-EPIC-ABOUT` — EPIC About Page. Self-reported profile; corroboration pending.
[^2]: `SRC-EPIC-CONTACT` — EPIC Contact Page. Official organizational record.
...
- `ORG-EPIC` cites `SRC-EPIC-ABOUT`.
- `ORG-EPIC` cites `SRC-EPIC-CONTACT`.
