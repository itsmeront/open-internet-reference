...
[^1]: `SRC-RCFP-WHAT-WE-DO` — Reporters Committee What We Do Page. Official source; review reliability tier.
[^2]: `SRC-RCFP-CONTACT` — Reporters Committee Contact Page. Official organizational record.
...
- `ORG-RCFP` cites `SRC-RCFP-WHAT-WE-DO`.
- `ORG-RCFP` cites `SRC-RCFP-CONTACT`.
