...
[^1]: `SRC-GNUNET-ABOUT` — GNUnet About Page. Official project page.
[^2]: `SRC-LWN-GNUNET-INTRO-2005` — LWN.net introduction to GNUnet (2005). Technical journalism; verify current protocol details against modern GNUnet docs.
...
- `TECH-GNUNET` cites `SRC-GNUNET-ABOUT`.
- `TECH-GNUNET` cites `SRC-LWN-GNUNET-INTRO-2005`.
- `TECH-GNUNET` related_to `TOPIC-DECENTRALIZED-MODERATION`.
- `TECH-GNUNET` related_to `TECH-HYPHANET`.

## Sources

1. `SRC-GNUNET-ABOUT`: GNUnet About Page.
2. `SRC-LWN-GNUNET-INTRO-2005`: LWN.net — An Introduction to GNUnet (2005).
