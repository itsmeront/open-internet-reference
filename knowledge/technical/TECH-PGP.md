...
[^1]: `SRC-ZIMMERMANN-BIO` — Phil Zimmermann Official Biography. Self-reported profile; corroboration pending for design details beyond investigation outcome.
...
- `TECH-PGP` cites `SRC-ZIMMERMANN-BIO`.
