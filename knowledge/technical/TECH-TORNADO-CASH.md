...
[^1]: `SRC-VAN-LOON-5TH-CIR-JUSTIA` — Van Loon v. Department of the Treasury, No. 23-50669 (5th Cir. Nov. 26, 2024) (Justia). Primary authority for technical description used by the court.
...
[^3]: `SRC-OFAC-FAQ-1076` — OFAC FAQ 1076 — Prohibitions Resulting from Tornado Cash Designation. Official OFAC FAQ.
...
- `TECH-TORNADO-CASH` cites `SRC-VAN-LOON-5TH-CIR-JUSTIA`.
...
3. `SRC-OFAC-FAQ-1076`: OFAC FAQ 1076 — Prohibitions Resulting from Tornado Cash Designation.
