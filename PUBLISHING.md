...
| Asset | Use |
| --- | --- |
| `oir-logo-mark.svg` | Site header logo and favicon source |
| `oir-logo-v5-fullmesh.svg` | Print handbook cover only |

Raster favicon files are generated from `oir-logo-mark.svg`:
